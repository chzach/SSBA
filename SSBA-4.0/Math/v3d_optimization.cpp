...
//                cout << endl;
            ...
            if (currentIteration == 0)
            {
               ...
               else
               {
                  ...
                  cout << "SparseLevenbergOptimizer: initial lambda = " << tau*maxEl
         ...
         if (success)
         {
            ...
            if (optimizerVerbosenessLevel >= 2)
               cout << "SparseLevenbergOptimizer: ||delta|| = " << sqrt(deltaSqrLength) << " ||paramLength|| = " << paramLength << endl;
            ...
            // if (optimizerVerbosenessLevel >= 2)
            //    cout << "SparseLevenbergOptimizer: |deltaAi|^2 = " << squaredResidual(deltaAi) << " |deltaBj|^2 = " << squaredResidual(deltaBj) << endl;
            ...
            double const newErr = squaredResidual(residuals);
            rho = err - newErr;
            if (optimizerVerbosenessLevel >= 2)
               cout << "SparseLevenbergOptimizer: |new residual|^2 = " << newErr << " rho = " << rho << endl;
