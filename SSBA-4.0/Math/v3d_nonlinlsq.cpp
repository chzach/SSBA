...
//======================================================================
   ...
   NLSQ_LM_Optimizer::minimize()
   {
      ...
      if (_totalParamCount == 0)
      {
         ...
         if (optimizerVerbosenessLevel >= 2) cout << "NLSQ_LM_Optimizer: exiting since d.o.f is zero." << endl;
      ...
      for (currentIteration = 0; currentIteration < maxIterations; ++currentIteration)
      {
         ...
         if (computeDerivatives)
         {
            ...
            if (this->applyGradientStoppingCriteria(norm_Linf_Jt_e))
            {
         ...
         if (optimizerVerbosenessLevel >= 2 && currentIteration+1 >= maxIterations)
            cout << "NLSQ_LM_Optimizer: reached maximum number of iterations, exiting." << endl;
